...
INSERT INTO SHARE (user_id, stock_id, email_to_share_with) VALUES ((SELECT id FROM USER WHERE last_name = 'Smith'), (SELECT id FROM STOCK WHERE stock_ticker = 'XOM'), 'bobsmith@gmail.com');
...
INSERT INTO FAVORITE (user_id, stock_id) VALUES ((SELECT id FROM USER WHERE last_name = 'Rachael'), (SELECT id FROM STOCK WHERE stock_ticker = 'NFLX'));
